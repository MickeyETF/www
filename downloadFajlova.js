function DownloadFajlova(var br_ind,var loz)
	{
		alert("poziva se download fajlova");
		...
		downloadFile = function(adresa,ime_fajla)
		{
		alert("vrsi se dovnload"+ime_fajla);
		var fileTransfer = new FileTransfer();
		var filePath = window.appRootDir.fullPath + file;
